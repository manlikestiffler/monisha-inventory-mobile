...
// Deficit Report Store for Mobile App
export const deficitReportStore = {
  // Generate and store deficit report
  ...
  refreshDeficitReports: async (schoolId, schoolData, studentsData) => {
    try {
      ...
      await deficitReportStore.cleanupOldDeficitReports(schoolId);
      
      // Generate new reports
      return await deficitReportStore.generateAndStoreDeficitReport(schoolId, schoolData, studentsData);
    } catch (error) {
